...
int test_2c_float_signal(void) {
	...
	encode_can_0x400_float_signal_0(&msg, 1.25f);
	encode_can_0x400_float_signal_1(&msg, -9.5f);
	decode_can_0x400_float_signal_0(&msg, &out0);
	decode_can_0x400_float_signal_1(&msg, &out1);
