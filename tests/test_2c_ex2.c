...
int test_2c_ex2(void) {
	...
	encode_0x064_speed(&dynloc, 87.5f);
	encode_0x064_torque(&dynloc, -13.25f);
	decode_0x064_speed(&dynloc, &speed);
	decode_0x064_torque(&dynloc, &torque);
	...
	encode_0x401_limit_flags(&status, 0x0123u);
	encode_0x401_error_flags(&status, 0x0456u);
	encode_0x401_active_motor(&status, 2u);
	encode_0x401_transmit_error_count(&status, 7u);
	encode_0x401_receive_error_count(&status, 9u);
	decode_0x401_limit_flags(&status, &limit_flags);
	decode_0x401_error_flags(&status, &error_flags);
	decode_0x401_active_motor(&status, &active_motor);
	decode_0x401_transmit_error_count(&status, &tx_errors);
	decode_0x401_receive_error_count(&status, &rx_errors);
	...
	encode_0x402_bus_voltage(&bus, 410.75f);
	encode_0x402_bus_current(&bus, 15.5f);
	decode_0x402_bus_voltage(&bus, &bus_voltage);
	decode_0x402_bus_current(&bus, &bus_current);
	...
	encode_0x417_slip_speed(&slip, 1.5f);
	encode_0x417_reserved_2(&slip, -0.5f);
	decode_0x417_slip_speed(&slip, &slip_speed);
	decode_0x417_reserved_2(&slip, &reserved_2);
